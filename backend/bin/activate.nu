...
def-env activate-virtualenv [] {
    ...
    let virtual-env = '/Users/ayman/Desktop/heart-disease-bdbi/backend'
    let bin = 'bin'
    let path-sep = ':'
...
alias deactivate = source '/Users/ayman/Desktop/heart-disease-bdbi/backend/bin/deactivate.nu'
